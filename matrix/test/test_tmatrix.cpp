...
TEST(TDynamicMatrix, can_divide_matrixes_with_equal_size)
{
	TDynamicMatrix<double> m(2), m1(2), m2(2);
	m[0][0] = 13;
	m[0][1] = 26;
	m[1][0] = 39;
	m[1][1] = 13;
...
TEST(TDynamicMatrix, cant_divide_matrixes_with_not_equal_size)
{
	TDynamicMatrix<int> m(4), m1(2);
	ASSERT_ANY_THROW(m / m1);
}